	...
	<nav class="navbar fixed-top navbar-expand-md navbar-light bg-faded" style="background-color:#e3f2fd;">
	  ...
	  <div class="collapse navbar-collapse" id="navbarText">
		<ul class="navbar-nav mr-auto">
		  <li class="nav-item">
			<a class="nav-link" href="<?php echo site_url('predictions'); ?>">Predictions</a>
		  </li>
		  <li class="nav-item">
		  ...
		  <?php if($this->ion_auth->is_admin()) {
		  	echo '<li class="nav-item"><a class="nav-link" href="'.site_url('updateresultscronscript').'">Update results</a></li>';
		  }?>
		</ul>
			<form action="<?php echo site_url('user/logout'); ?>"><button type="submit" class="btn btn-success">Logout</button></form>
	  </div>
	</nav>
